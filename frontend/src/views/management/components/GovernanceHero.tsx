    ...
    return (
        <Box {...props}>
            ...
            <Text as="p" variant="legend" sx={{ maxWidth: 500 }}>
                <Trans>
                    Your Rtoken has been deployed and the "owner" role is set to your wallet. Next,
                    let's configure a robust governance module for your currency. We recommend the
                    default Reserve Governor Alexios but it is a flexible platform.
                </Trans>
            </Text>
            <Flex mt={4}>
