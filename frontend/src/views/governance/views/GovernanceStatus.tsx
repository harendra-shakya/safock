...
const Pending = () => (
    <Box sx={{ textAlign: "center", width: 400 }}>
        ...
        <Text as="p" variant="legend">
            <Trans>
                Please sign the transaction in your wallet to continue with the government
...
const Mining = ({ hash }: { hash: string }) => (
    <Box sx={{ textAlign: "center", width: 420 }}>
        ...
        <Text as="p" variant="legend">
            <Trans>
                Stay patient while the transaction is in progress & don’t close this window to
