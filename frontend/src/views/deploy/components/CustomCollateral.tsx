...
const CustomCollateral = ({ onAdd }: { onAdd(collateral: CollateralPlugin): void }) => {
    ...
    const validatePlugin = useCallback(async (address: string, provider: Web3Provider) => {
        try {
            setValidating(true);
            const callParams = {
            ...
            const [isCollateral, targetUnit, erc20, rewardERC20] = await promiseMulticall(
                [
        ...
        return (
            <Box>
                ...
                <Flex mt={3}>
                    ...
                    <SmallButton ml="auto" disabled={!!error || isValidating} onClick={handleAdd}>
