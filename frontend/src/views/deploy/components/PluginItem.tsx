...
import { Box, BoxProps, Checkbox, Divider, Flex, IconButton, Link, Text } from "theme-ui";
    ...
    <>
        ...
        <Flex variant="layout.verticalAlign" ml={4} mt={3} sx={{ fontSize: 1 }}>
            ...
            <Box mr={4}>
                ...
                <Link
                    as="a"
                    href={getExplorerLink(data.collateralAddress!, ExplorerDataType.TOKEN)}
                    target="_blank"
                    variant="legend"
    ...
    return (
        <Box {...props}>
            <Flex variant="layout.verticalAlign">
                ...
                >
                    {isVisible ? <ChevronUp color="#999999" /> : <ChevronDown color="#999999" />}
                </IconButton>
            </Flex>
