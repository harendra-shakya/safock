...
export interface StRsrInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "MAX_REWARD_PERIOD", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rewardPeriod", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "MAX_REWARD_PERIOD", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "rewardPeriod", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setRewardPeriod", data: BytesLike): Result;
...
export type RewardPeriodSetEvent = TypedEvent<[number, number], RewardPeriodSetEventObject>;
...
export interface StRsr extends BaseContract {
    ...
    callStatic: {
        ...
        setName(name_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
