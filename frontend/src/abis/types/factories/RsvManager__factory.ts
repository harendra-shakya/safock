...
import type { RsvManager, RsvManagerInterface } from "../RsvManager";
...
export class RsvManager__factory {
    ...
    static createInterface(): RsvManagerInterface {
        return new utils.Interface(_abi) as RsvManagerInterface;
    }
    static connect(address: string, signerOrProvider: Signer | Provider): RsvManager {
        return new Contract(address, _abi, signerOrProvider) as RsvManager;
    }
}
